...
$date = new Date();
$date->set_format('j F Y');
$template_source = base_url('asset/template/');
?>
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  ...
  <!-- inject:css -->
  <link rel="stylesheet" href="<?php echo $template_source ?>css/style.css">
  <!-- endinject -->
  <link rel="shortcut icon" href="<?php echo $template_source ?>images/favicon.png" />
</head>
...
<body>
              ...
              <div class="card card-weather">
                <div class="card-body">
                  <div class="weather-date-location">
                    ...
                    <p class="text-gray">
                      <span class="weather-date"><?php echo $date->get_date(); ?></span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2018
              Team 2 Topik Khusus Teknik Informatika</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
  ...
  <!-- plugins:js -->
  <script src="<?php echo $template_source ?>vendors/js/vendor.bundle.base.js"></script>
  <script src="<?php echo $template_source ?>vendors/js/vendor.bundle.addons.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  <script src="<?php echo $template_source ?>js/off-canvas.js"></script>
  <script src="<?php echo $template_source ?>js/misc.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="<?php echo $template_source ?>js/dashboard.js"></script>
